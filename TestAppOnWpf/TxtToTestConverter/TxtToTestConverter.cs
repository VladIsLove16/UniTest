...
namespace TestAppOnWpf.Converters
{
    internal class TxtToTestConverter
    {
        private string testsPath;
        private string answersPath;
        public  string TestsPath { get { return testsPath; } set => testsPath = value; }
        public  string AnswersPath { get { return answersPath; } set => answersPath = value; }
        private TxtToTestConverter() { }
        public TxtToTestConverter(string testsPath, string answersPath)
        {
            TestsPath = testsPath;
            AnswersPath = answersPath;
        }
        public List<Test> LoadDefaultTests()
        {
        ...
        public Test LoadTestFromDirectory(string filepath)
        {
